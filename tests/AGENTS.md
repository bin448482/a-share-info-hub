...
- `test_daily_review.py`：覆盖每日复盘研究的 `review-context.json`、Pydantic 校验、LLM sections 校验、external background passed/partial/blocked/invalid 校验、`1.1 大盘` HTML 段落、HTML 首屏边界、技术参考 Markdown、partial 降级、skipped 非交易日阻断、missing 日期阻断、交易建议拒绝和公开 CLI 刷新契约。
