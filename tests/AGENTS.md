...
- `test_external_background_orchestration.py`：覆盖每日复盘外部背景 fixture/validation helper 的 6 topic 抽取、runner 派发次数、blocked topic 降级、fusion 汇总、现有 daily-review 校验路径兼容和公开 CLI smoke。
